      ...
      <section className="flex flex-col bg-white py-20 text-3xl md:text-4xl">
         ...
         <div className="container mx-auto px-11 text-center mt-28">
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 lg:gap-20">
               ...
               <Member id="02" name="Luc" socialId="@lucbeck" link="https://github.com/brunoliimas"/>
               <Member id="04" name="Anne" socialId="@annefrank" link="https://github.com/brunoliimas"/>
               <Member id="03" name="Cleo" socialId="@cleopires" link="https://github.com/brunoliimas"/>
               <Member id="01" name="Marc" socialId="@marcoli" link="https://github.com/brunoliimas"/>
            </div>
         </div>
      </section>
